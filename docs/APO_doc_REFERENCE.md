...
Some random notes about [Windows Audio Processing Objects][apo] (APOs).
...
The configuration is organized as a set of registry values, which correspond to
individual properties. A property is identified by a GUID, followed by a comma
